...
define ('TP_CONSUMER_KEY', '86e6a2fd595deb98');
define ('TP_CONSUMER_SECRET', '4SmzqmjV');
define ('TP_GENERAL_PURPOSE_KEY', 'DMWpDoZzZ5zQJf2K');
define ('TP_GENERAL_PURPOSE_SECRET', 'rcHo0TBhTZpSPThV');
...
// or logout. 
define ('TP_RETURN_URL', 'http://kevin-shays-computer-2.local/php-typepad-api/examples/blog_crud/index.php');
...
define ('TP_SYNC_URL', 'http://kevin-shays-computer-2.local/php-typepad-api/examples/blog_crud/sync.php');
...
define ('TP_API_BASE', 'http://api.typepad.com.kshay-eng.dev.sixapart.com');
define ('TP_API_BASE_SECURE', 'https://api.typepad.com.kshay-eng.dev.sixapart.com');
