...
// or logout. 
define ('TP_RETURN_URL', 'http://kevin-shays-computer-2.local/php-typepad-api/site/index.php');
...
define ('TP_SYNC_URL', 'http://kevin-shays-computer-2.local/php-typepad-api/site/sync.php');
